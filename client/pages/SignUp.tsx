    ...
    <div className="min-h-screen bg-gradient-to-br from-escz-navy to-escz-navy/90 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-xl">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-escz-cream mb-2">Sign Up</h2>
          <p className="text-escz-cream/70">Create an admin account</p>
        </div>
        
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-escz-cream mb-2">Name</label>
            <input
              type="text"
              value={name}
        ...
        <p className="text-center text-escz-cream/70 mt-6">
          ...
          <Link to="/signin" className="text-escz-orange hover:underline">
            Sign In
          </Link>
        </p>
      </div>
